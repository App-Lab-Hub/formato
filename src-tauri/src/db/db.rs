...
use crate::db::models::{Conversions, FormatActiveModel, FormatModel, Formats};
...
pub async fn db_init() -> Result<DatabaseConnection, sea_orm::DbErr> {
    ...
    create_tables!(db, Formats, Conversions);
...
async fn init_formats(db: &DatabaseConnection) -> Result<(), DbErr> {
    ...
    let formats = vec![
        ...
        "dark:outline-yellow-500/50 light:outline-yellow-600/50",
        ...
        "dark:outline-blue-500/50 light:outline-blue-600/50",
        ...
        "dark:outline-green-500/50 light:outline-green-600/50",
        ...
        "dark:outline-orange-500/50 light:outline-orange-600/50",
        ...
        "dark:outline-orange-400/50 light:outline-orange-500/50",
        "dark:text-orange-400 light:text-orange-700",
        ...
        "dark:outline-gray-400/50 light:outline-gray-500/50",
        ...
        "dark:outline-purple-500/50 light:outline-purple-600/50",
        ...
        "dark:outline-gray-500/50 light:outline-gray-600/50",
        "dark:text-gray-400 light:text-gray-700",
        ...
        "dark:outline-blue-400/50 light:outline-blue-500/50",
        "dark:text-blue-400 light:text-blue-700",
        ...
        "dark:outline-red-500/50 light:outline-red-600/50",
        ...
        "dark:outline-blue-600/50 light:outline-blue-700/50",
        "dark:text-blue-400 light:text-blue-700",
        "dark:hover:border-blue-500/60 light:hover:border-blue-600/50",
        "document"),
        ...
        "dark:outline-green-600/50 light:outline-green-700/50",
        "dark:text-green-400 light:text-green-700",
        "dark:hover:border-green-500/60 light:hover:border-green-600/50",
        "document"),
        ...
        "dark:outline-emerald-500/50 light:outline-emerald-600/50",
        ...
        "dark:outline-cyan-500/50 light:outline-cyan-600/50",
        ...
        "dark:outline-pink-500/50 light:outline-pink-600/50",
        ...
        "dark:outline-indigo-500/50 light:outline-indigo-600/50",
        ...
        "dark:outline-rose-500/50 light:outline-rose-600/50",
        ...
        "dark:outline-amber-500/50 light:outline-amber-600/50",
        ...
        "dark:outline-lime-500/50 light:outline-lime-600/50",
        ...
        "dark:outline-violet-500/50 light:outline-violet-600/50",
        ...
        "dark:outline-teal-500/50 light:outline-teal-600/50",
        ...
        "dark:outline-fuchsia-500/50 light:outline-fuchsia-600/50",
        ...
        "dark:outline-red-600/50 light:outline-red-700/50",
        "dark:text-red-400 light:text-red-700",
        "dark:hover:border-red-500/60 light:hover:border-red-600/50",
        "video"),
        ...
        "dark:outline-purple-600/50 light:outline-purple-700/50",
        "dark:text-purple-400 light:text-purple-700",
        "dark:hover:border-purple-500/60 light:hover:border-purple-600/50",
        "video"),
        ...
        "dark:outline-cyan-600/50 light:outline-cyan-700/50",
        "dark:text-cyan-400 light:text-cyan-700",
        "dark:hover:border-cyan-500/60 light:hover:border-cyan-600/50",
        "video"),
        ...
        "dark:outline-indigo-600/50 light:outline-indigo-700/50",
        "dark:text-indigo-400 light:text-indigo-700",
        "dark:hover:border-indigo-500/60 light:hover:border-indigo-600/50",
        "video"),
        ...
        "dark:outline-orange-600/50 light:outline-orange-700/50",
        "dark:text-orange-400 light:text-orange-700",
        "dark:hover:border-orange-500/60 light:hover:border-orange-600/50",
        "video"),
        ...
        "dark:outline-rose-600/50 light:outline-rose-700/50",
        "dark:text-rose-400 light:text-rose-700",
        "dark:hover:border-rose-500/60 light:hover:border-rose-600/50",
        "video"),
        ...
        "dark:outline-teal-600/50 light:outline-teal-700/50",
        "dark:text-teal-400 light:text-teal-700",
        "dark:hover:border-teal-500/60 light:hover:border-teal-600/50",
        "video"),
        ...
        "dark:outline-amber-600/50 light:outline-amber-700/50",
        "dark:text-amber-400 light:text-amber-700",
        "dark:hover:border-amber-500/60 light:hover:border-amber-600/50",
        "video"),
    ...
    for (format_id, name, extensions, icon, color, glow, text_color, border_hover, format_type) in
        formats
    {
...
pub async fn get_all_formats(db: &DatabaseConnection) -> Result<Vec<FormatModel>, DbErr> {
...
use chrono::Utc;
use conversions::{Column, Entity};
pub async fn find_conversion(db: &DatabaseConnection, file_hash: &str) -> Option<String> {
...
pub async fn reset_database(state: tauri::State<'_, AppState>) -> Result<(), String> {
    ...
    crate::create_tables!(db, Formats, Conversions);
...
mod tests {
    ...
    async fn test_db_init_creates_tables() {
        ...
        assert_eq!(
            conversions_count, 0,
            "Conversions table should be empty initially"
        );
    }
    ...
    async fn test_format_types_count() {
        ...
        println!(
            "📊 Format counts: text={}, document={}, image={}, audio={}, video={}",
    ...
    async fn test_all_formats_have_required_fields() {
        ...
        for format in formats {
            ...
            assert!(
                ...
                "Format name is empty for {}",
                format.format_id
            );
            assert!(
                !format.icon.is_empty(),
                "Format icon is empty for {}",
                format.format_id
            );
            assert!(
                !format.color.is_empty(),
                "Format color is empty for {}",
                format.format_id
            );
            assert!(
                !format.glow.is_empty(),
                "Format glow is empty for {}",
                format.format_id
            );
            assert!(
                !format.text_color.is_empty(),
                "Format text_color is empty for {}",
                format.format_id
            );
            assert!(
                !format.border_hover.is_empty(),
                "Format border_hover is empty for {}",
                format.format_id
            );
            assert!(
                !format.format_type.is_empty(),
                "Format type is empty for {}",
                format.format_id
            );
