...
<div class="flex items-center w-full sm:w-auto">
  <div 
    ...
    class="justify-around tabs-container relative flex items-center w-full sm:w-fit dark:bg-card/30 light:bg-purple-200/30 p-1 rounded-xl border dark:border-border/50 light:border-purple-300/40 h-10 min-w-[200px]"
  >
    <!-- Плавающая плашка -->
